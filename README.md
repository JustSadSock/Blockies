...
A cute Tetris-like game with single-player and local multiplayer support (2-4 players).

## Features

- ✨ **Single-player mode** - Play classic Tetris alone
- 👥 **Local multiplayer** - Play with 2-4 players on the same computer
- ⌨️ **Customizable controls** - Configure key bindings for each player
- 🎨 **Custom colors** - Choose your own block colors
- 💝 **Cute, simple design** - Beautiful gradient interface with smooth animations
...
- **Customize** - Click "Settings" to change key bindings and colors for each player
